...
export default function LandingPage() {
  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <Banner id='coming-soon' header='JPSampietri Spotting' subtext='Pistons, gas, camera, action' subtextClass='' imageLightPath={navbarProps.logoLightPath} imageDarkPath={navbarProps.logoDarkPath} />
